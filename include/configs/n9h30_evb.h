 ...
 *
 * Configuation settings for the N9H30 EV Board.
 *
...
/*#define CONFIG_N9H30_HW_CHECKSUM */
...
#define CONFIG_NR_DRAM_BANKS    2     /* there are 2 sdram banks for n9h30 */
...
/*#define CONFIG_N9H30_SD_PORT0 */
/*#define CONFIG_N9H30_SD_PORT1 */
/*#define CONFIG_N9H30_EMMC */      /* Don't enable eMMC(CONFIG_N9H30_EMMC) and NAND(CONFIG_NAND_N9H30) at the same time! */
