 ...
 *
 * Copyright (c) 2013 by Nuvoton Electronics Corporation
 * All rights reserved
 *
 * FILENAME
 *     crypto.h
...
typedef struct
{
	...
	UINT32 IPSEC_INT_FLAG;				/*!< Offset: 0x0004   IPsec interrupt flag                               */
...
typedef struct
{
	UINT32 KEYEN;					/*!< Offset: 0x0000   Key Enable Register		*/
	UINT32 RESERVED1[2];				/*!< Offset: 0x0004 ~ 0x0008 Reserved			*/
	UINT32 USERDATA;				/*!< Offset: 0x000C   User Defined Data Register	*/
	UINT32 KEY_0;					/*!< Offset: 0x0010   Key Word 0 Register		*/
	UINT32 KEY_1;					/*!< Offset: 0x0014   Key Word 1 Register		*/
	UINT32 KEY_2;					/*!< Offset: 0x0018   Key Word 2 Register		*/
	UINT32 KEY_3;					/*!< Offset: 0x001C   Key Word 3 Register		*/
	UINT32 KEY_4;					/*!< Offset: 0x0020   Key Word 4 Register		*/
	UINT32 KEY_5;					/*!< Offset: 0x0024   Key Word 5 Register		*/
	UINT32 KEY_6;					/*!< Offset: 0x0028   Key Word 6 Register		*/
	UINT32 KEY_7;					/*!< Offset: 0x002C   Key Word 7 Register		*/
	UINT32 PCYCLE;					/*!< Offset: 0x0030   Program Cycle Control Register	*/
	UINT32 CTL;					/*!< Offset: 0x0034   Control Register			*/
	UINT32 PSTART;					/*!< Offset: 0x0038   Program Start Register		*/
	UINT32 RESERVED2;				/*!< Offset: 0x003C   Reserved				*/
	UINT32 STATUS;					/*!< Offset: 0x0040   Status Register			*/
	UINT32 RESERVED3[3];				/*!< Offset: 0x0044 ~ 0x004C Reserved			*/
	UINT32 REGLCTL;					/*!< Offset: 0x0050   Write-Protection Control Register */
} MTP_TypeDef;

#define MTP				((MTP_TypeDef *) OTP_BA)

#define MTP_KEYEN_KEYEN			((UINT32)0x00000001)
#define MTP_CTL_OP_MASK			((UINT32)0x00000003)
#define MTP_CTL_OP_IDLE			((UINT32)0x00000000)
#define MTP_CTL_OP_PROG			((UINT32)0x00000002)
#define MTP_CTL_OP_LOCK			((UINT32)0x00000003)

#define MTP_PSTART_PSTART		((UINT32)0x00000001)

#define MTP_STATUS_MTPEN		((UINT32)0x00000001)
#define MTP_STATUS_KEYVALID		((UINT32)0x00000002)
#define MTP_STATUS_NONPRG		((UINT32)0x00000004)
#define MTP_STATUS_LOCKED		((UINT32)0x00000008)
#define MTP_STATUS_PRGFAIL		((UINT32)0x00000010)
#define MTP_STATUS_CNT_MACK		((UINT32)0x000F0000)
#define MTP_STATUS_BUSY			((UINT32)0x01000000)

#define MTP_REGLCTL_PWD_MASK		((UINT32)0x000000FF)
#define MTP_REGLCTL_PRTDIS		((UINT32)0x00000001)
