...
volatile int32_t N9H30_I2C_SPEED = 100;
 ...
 * Initialization
 */
static void n9h30_i2c_init(struct i2c_adapter *adap, int speed, int slaveaddr)
{
	//printf("\n soft_i2c_init  0x%x \n", adap->hwadapnr);
	...
	if (adap->hwadapnr == 0)
	{
		...
		#if defined (CONFIG_ENABLE_N9H30_I2C0)
		N9H30_I2C_SPEED = CONFIG_N9H30_I2C0_SPEED;
		#endif

		/* Configure multi function pins to I2C0 */
		#if defined (CONFIG_N9H30_I2C0_PG)
	...
	else
	{
		...
		#if defined (CONFIG_ENABLE_N9H30_I2C1)
		N9H30_I2C_SPEED = CONFIG_N9H30_I2C1_SPEED;
		#endif
	}
	...
	i2cIoctl(I2CNUM, I2C_IOC_SET_SPEED, N9H30_I2C_SPEED, 0);
}

/*-----------------------------------------------------------------------
 * Probe to see if a chip is present.
 */
static int n9h30_i2c_probe(struct i2c_adapter *adap, uint8_t addr)
{
	return 1;
}
 ...
 * Read bytes
 */
static int  n9h30_i2c_read(struct i2c_adapter *adap, uchar chip, uint addr,
 ...
 * Write bytes
 */
static int  n9h30_i2c_write(struct i2c_adapter *adap, uchar chip, uint addr,
			int alen, uchar *buffer, int len)
{
	int i, j;
	//int tmp;
 ...
 */
U_BOOT_I2C_ADAP_COMPLETE(I2CNUM_0, n9h30_i2c_init, n9h30_i2c_probe,
			 n9h30_i2c_read, n9h30_i2c_write, NULL/* _set_speed */,
			 CONFIG_N9H30_I2C0_SPEED, CONFIG_SYS_I2C_SLAVE,
			 0)

#if defined (CONFIG_ENABLE_N9H30_I2C1)
U_BOOT_I2C_ADAP_COMPLETE(I2CNUM_1, n9h30_i2c_init, n9h30_i2c_probe,
			 n9h30_i2c_read, n9h30_i2c_write, NULL,
			 CONFIG_N9H30_I2C1_SPEED,
