...
{
        struct n9h30_spi_slave  *ns;
        
        ns = malloc(sizeof(struct n9h30_spi_slave));
        if (!ns)
                return NULL;
        memset(ns,0,sizeof(struct n9h30_spi_slave));
...
{
        struct n9h30_spi_slave *ns = to_n9h30_spi(slave);
