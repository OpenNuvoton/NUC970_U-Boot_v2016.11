...
#ifndef _N9H30_SPI_H_
#define _N9H30_SPI_H_

#define USE_N9H30_SPI0 
//#define USE_N9H30_SPI1

#ifdef USE_N9H30_SPI0
...
struct n9h30_spi_slave {
        struct spi_slave slave;
        unsigned int max_hz;
        unsigned int mode;
};

static inline struct n9h30_spi_slave *to_n9h30_spi(struct spi_slave *slave)
{
        return container_of(slave, struct n9h30_spi_slave, slave);
}
