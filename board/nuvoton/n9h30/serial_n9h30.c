...
//#include "serial_n9h30.h"
#include <asm/arch/serial_n9h30.h>


DECLARE_GLOBAL_DATA_PTR;

int n9h30_serial_init (void);
void n9h30_serial_putc (const char ch);
void n9h30_serial_puts (const char *s);
int n9h30_serial_getc (void);
int n9h30_serial_tstc (void);
void n9h30_serial_setbrg (void);
...
static struct serial_device n9h30_serial_drv = {
        .name   = "n9h30_serial",
        .start  = n9h30_serial_init,
        .stop   = NULL,
        .setbrg = n9h30_serial_setbrg,
        .putc   = n9h30_serial_putc,
        .puts   = n9h30_serial_puts,
        .getc   = n9h30_serial_getc,
        .tstc   = n9h30_serial_tstc,
};

void n9h30_serial_initialize(void)
{
        serial_register(&n9h30_serial_drv);
}

__weak struct serial_device *default_serial_console(void)
{
        return &n9h30_serial_drv;
}
