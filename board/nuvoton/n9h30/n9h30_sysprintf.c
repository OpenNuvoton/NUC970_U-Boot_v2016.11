...
extern void n9h30_serial_putc (const char ch);
extern void n9h30_serial_puts (const char *s);
extern int n9h30_serial_getc (void);
extern int n9h30_serial_tstc (void);
extern void n9h30_serial_setbrg (void);
