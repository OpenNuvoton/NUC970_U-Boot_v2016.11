...
int n9h30_nand_read_page_hwecc_oob_first(struct mtd_info *mtd, struct nand_chip *chip, uint8_t *buf, int oob_required, int page);
void n9h30_nand_command_lp(struct mtd_info *mtd, unsigned int command, int column, int page_addr);
unsigned char n9h30_nand_read_byte(struct mtd_info *mtd);
//#define debug printf
...
struct n9h30_nand_info g_n9h30_nand;
...
int board_nand_init(struct nand_chip *nand)
{
    ...
    n9h30_nand = &g_n9h30_nand; //CWWeng 
    memset((void*)n9h30_nand,0,sizeof(struct n9h30_nand_info)); //CWWeng
