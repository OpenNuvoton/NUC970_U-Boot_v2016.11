...
int board_mmc_init(bd_t *bd)
{
...
#if defined(CONFIG_N9H30_SD_PORT0) || defined(CONFIG_N9H30_SD_PORT1)
...
#ifdef CONFIG_N9H30_SD_PORT0
    writel(0x66666666, REG_MFP_GPD_L);   // Set GPD for SD0

    n9h30_mmc_init(0); // init for SD port 0
#endif
#ifdef CONFIG_N9H30_SD_PORT1
    ...
    n9h30_mmc_init(1); // init for SD port 1
#endif

#ifdef CONFIG_N9H30_EMMC
#ifdef CONFIG_NAND_N9H30
# error Do not enable eMMC(CONFIG_N9H30_EMMC) and NAND(CONFIG_NAND_N9H30) at the same time!
#endif
    ...
    n9h30_mmc_init(2); // init for eMMC
#endif
