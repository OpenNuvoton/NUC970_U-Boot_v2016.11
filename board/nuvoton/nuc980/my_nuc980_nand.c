...
int nuc980_nand_read_page_hwecc_oob_first(struct mtd_info *mtd, struct nand_chip *chip, uint8_t *buf, int oob_required, int page);
void nuc980_nand_command_lp(struct mtd_info *mtd, unsigned int command, int column, int page_addr);
unsigned char nuc980_nand_read_byte(struct mtd_info *mtd);
...
struct nuc980_nand_info g_nuc980_nand;
...
//debug("nuc980_nand_read_byte <0x%x>\n", val);
//    return val;
 ...
 */
//static int nuc980_nand_read_page_hwecc_oob_first(struct mtd_info *mtd, struct nand_chip *chip, uint8_t *buf, int page) //CWWeng 2017.2.14
 ...
 */
//static int nuc980_nand_read_oob_hwecc(struct mtd_info *mtd, struct nand_chip *chip, int page, int sndcmd) //CWWeng 2017.2.14
...
int board_nand_init(struct nand_chip *nand)
{
	...
	nuc980_nand = &g_nuc980_nand; //CWWeng
	memset((void*)nuc980_nand,0,sizeof(struct nuc980_nand_info)); //CWWeng
